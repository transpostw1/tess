...
<div class="card">
	...
	{!! Form::open(array('url'=>'sales?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("sales/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
